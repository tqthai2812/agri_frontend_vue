<template>
  ...
  >
    <button class="w-10 h-10 rounded-lg bg-bg border border-border flex items-center justify-center hover:bg-primary/10 hover:text-primary transition"
    ...
    <div class="flex items-center gap-3">
      <div class="hidden md:flex items-center gap-2 bg-bg border border-border rounded-lg px-3 py-2 w-64 focus-within:border-primary focus-within:shadow-primary/20">
      ...
      <button class="w-10 h-10 rounded-lg bg-bg border border-border flex items-center justify-center relative">
        ...
        <span class="absolute -top-1 -right-1 w-4 h-4 bg-primary rounded-full text-[10px] text-white flex items-center justify-center">4</span>
      </button>

      <button @click="$emit('toggle-dark')" class="w-10 h-10 rounded-lg bg-bg border border-border flex items-center justify-center">
        <Icon :icon="darkMode ? 'solar:sun-bold' : 'solar:moon-bold'" class="text-xl" />
      </button>

      <div class="avatar w-9 h-9 rounded-full bg-primary flex items-center justify-center text-white font-bold cursor-pointer">EV</div>
